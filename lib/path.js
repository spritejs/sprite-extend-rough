...
function install(_ref) {
  ...
  var parseValue = utils.parseValue,
      attr = utils.attr,
      flow = utils.flow;
  var RoughPathAttr = (_dec = parseValue(parseFloat), (_class = function (_Rough$Attr) {
  ...
  }(Rough.Attr), (_applyDecoratedDescriptor(_class.prototype, 'simplification', [_dec, attr], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'simplification'), _class.prototype)), _class));
