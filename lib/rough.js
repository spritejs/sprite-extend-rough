...
function install(_ref) {
  var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _desc, _value, _class, _class2, _temp;
  ...
  var RoughAttr = (_dec = parseValue(parseColorString), _dec2 = inherit('rgba(0,0,0,1)'), _dec3 = inherit('normal normal normal 32px "Hannotate SC"'), _dec4 = parseValue(parseFloat), _dec5 = inherit(1), _dec6 = parseValue(parseFloat), _dec7 = inherit(1), _dec8 = parseValue(parseFloat), _dec9 = inherit(1), _dec10 = inherit('hachure'), _dec11 = parseValue(parseFloat), _dec12 = inherit(''), _dec13 = parseValue(parseFloat), _dec14 = inherit(-41), _dec15 = parseValue(parseFloat), _dec16 = inherit(''), (_class = function (_Path$Attr) {
      ...
      value: function render(t, context) {
        ...
        if (label) {
          this.once('afterdraw', function (_ref5) {
            ...
            context.fillStyle = _this3.attr('color');
