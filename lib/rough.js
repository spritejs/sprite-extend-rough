...
function install(_ref) {
  var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _desc, _value, _class, _class2, _temp;
  ...
  var RoughAttr = (_dec = inherit('normal normal normal 32px "Hannotate SC"'), _dec2 = parseValue(parseFloat), _dec3 = inherit(1), _dec4 = parseValue(parseFloat), _dec5 = inherit(1), _dec6 = parseValue(parseFloat), _dec7 = inherit(1), _dec8 = inherit('hachure'), _dec9 = parseValue(parseFloat), _dec10 = inherit(''), _dec11 = parseValue(parseFloat), _dec12 = inherit(-41), _dec13 = parseValue(parseFloat), _dec14 = inherit(''), (_class = function (_Path$Attr) {
